...
define('APPLICATION_TITLE', 'Manege');
...
define('DB_NAME', 'manegedatabase'); // Wat is de database naam
define('DB_USER', 'manegeadmin'); 		// Wat is de database gebruiker
define('DB_PASS', 'hh8fShFb8xUtER6H');		// Wat is het database wachtwoord
